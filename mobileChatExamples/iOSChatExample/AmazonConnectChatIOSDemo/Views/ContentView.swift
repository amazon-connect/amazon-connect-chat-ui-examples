...
struct ContentView: View {
    ...
    var body: some View {
        VStack {       
            ...
            //----- Show Console log button. Only for debugging purposes.
            Spacer()
            ...
            .padding()
            //----- END of Show Console log button.
        }
        //----- Console log window. Only for debugging purposes.
