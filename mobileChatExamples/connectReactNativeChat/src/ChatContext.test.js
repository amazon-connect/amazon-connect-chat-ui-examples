...
describe('ChatContext', () => {
  ...
  describe('ChatProvider', () => {
    ...
    it('should accept customerName prop', async () => {
      const TestComponent = () => {
      ...
      render(
        <ChatProvider customerName="Test Customer">
          <TestComponent />
        </ChatProvider>
      );
  ...
  describe('handleDisconnect', () => {
    it('should disconnect chat session', async () => {
      ...
      expect(mockChatSession.disconnectParticipant).toHaveBeenCalled();
      expect(AsyncStorage.removeItem).toHaveBeenCalled();
      expect(result.current.isChatActive).toBe(false);
    ...
    it('should not attempt to disconnect when no session exists', async () => {
      ...
      expect(mockChatSession.disconnectParticipant).not.toHaveBeenCalled();
    });
  });
});
