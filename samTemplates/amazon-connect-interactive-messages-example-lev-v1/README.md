...
Lex Bot V1 Lambda hook is no longer supported. Please go with [`amazon-connect-interactive-messages-example`](https://github.com/amazon-connect/amazon-connect-chat-ui-examples/blob/master/samTemplates/amazon-connect-interactive-messages-example) approach. 

`amazon-connect-interactive-messages-example` has been updated for Lex Bot V2 support, please refer to that lambda code hook instead.
